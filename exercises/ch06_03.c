...
/* of responses in the list, set up the program so that the value  999 can be keyed in by the */ 
/* user to indicate that the last response has been entered. ( Hint: You can use the  break */ 
