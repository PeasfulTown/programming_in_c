...
// The  E operator tells the program that execution is to end. The arithmetic
// operations are performed on the contents of the accumulator with the number
// that was keyed in acting as the second operand. The following is a “sample
// run” showing how the program should operate: 
// Begin Calculations
